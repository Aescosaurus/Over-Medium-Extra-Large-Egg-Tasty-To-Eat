...
LevelEditor::LevelEditor()
{
	...
	surfs.insert( { TileType::Empty,{ { "Images/Floor.bmp" },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::Wall,{ { "Images/Wall1.bmp" },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::Player,{ { { "Images/PlayerAnim.bmp" },RectI{ 0,8,0,8 } },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::Stairs,{ { "Images/Stairs.bmp" },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::EggSoldier,{ { { "Images/EggSoldierAnim.bmp" },RectI{ 0,8,0,8 } },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::Eggsploder,{ { { "Images/EggsploderAnim.bmp" },RectI{ 0,8,0,8 } },Vei2{ 4,4 } } } );
	// other stuff
	// other stuff
	surfs.insert( { TileType::KeyWall,{ { "Images/KeyWall.bmp" },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::Key,{ { "Images/Key.bmp" },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::SpikeWallLeft,{ { { "Images/SpikeWallAnim.bmp" },RectI{ 40,50,0,10 } },Vei2{ 4,4 } } } );
	surfs.insert( { TileType::SpikeWallRight,{ { { { "Images/SpikeWallAnim.bmp" },RectI{ 40,50,0,10 } },Vei2{ 4,4 } },true,false } } );
...
void LevelEditor::PutTile( int x,int y,TileType t )
{
	tiles[y * nTiles.x + x] = t;
}

LevelEditor::TileType LevelEditor::GetTile( int x,int y ) const
{
